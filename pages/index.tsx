...
const Home: NextPage = ({
  ...
  return (
    <div>
      <Head>
        <title>Disney+</title>
        <meta name="description" content="Watch your favourite movies and tv-shows here on DisneyPlus." />
      ...
      {!session ? (
        ...
        <main>
          ...
          <MoviesCollection results={marvel} title="Marvel Cinematic Universe"/>
